...
func _ready() -> void:
	MGIS.add_relation("demo4_inventory", "demo4_slot_inventory")
	MGIS.add_relation("demo4_slot_inventory", "demo4_inventory")
...
func _on_button_add_test_items_pressed() -> void:
	...
	MGIS.add_item("demo4_inventory", animal_1)
	#return
	var item_11 = load("res://mgis_demos/resources/equipment_2.tres")
	MGIS.add_item("demo4_inventory", item_11)
	...
	MGIS.add_item("demo4_inventory", item_10)
	MGIS.add_item("demo4_inventory", item_12)
	MGIS.add_item("demo4_inventory", item_2)
	MGIS.add_item("demo4_inventory", item_3)


func _on_button_save_pressed() -> void:
	MGIS.save("demo4_inventory", false)
	MGIS.save("demo4_slot_inventory", false)


func _on_button_load_pressed() -> void:
	MGIS.load("demo4_inventory")
	MGIS.load("demo4_slot_inventory")
